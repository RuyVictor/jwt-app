...
export default function EditProfile({ navigation }) {
    ...
    const handleUpdateUser = async (data: IFormInputs) => {
        ...
        if (data.userName === getUserData.user?.user_name) {
            return setAuthError('O nome de usuário digitado é igual ao nome atual!');
        }
    ...
    const [currentAvatarImage, setCurrentAvatarImage] = React.useState<string>(
